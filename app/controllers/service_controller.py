...
class ServiceController:
    ...
    async def create_service(self, user_address: str, private_key: str, service_data: dict) -> dict:
        try:
    ...
    async def toggle_service_status(self, user_address: str, private_key: str, service_id: int) -> dict:
        try:
